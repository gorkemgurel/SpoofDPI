...
curl "https://api.github.com/repos/gorkemgurel/SpoofDPI/releases/latest" |
    grep '"tag_name":' |
    sed -E 's/.*"([^"]+)".*/\1/' |
    xargs -I {} curl -OL "https://github.com/gorkemgurel/SpoofDPI/releases/download/"\{\}"/spoofdpi-${1}.tar.gz"
